...
/*   Updated: 2025/05/23 01:21:07 by psmolin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_map(t_gamestate *game)
{
	...
	ft_printf(COLOR_W "Checking bounds\n" COLOR_X);
	ft_check_bounds(game);
	ft_printf(COLOR_G "Checked\n" COLOR_X);
	ft_printf(COLOR_W "Checking map characters\n" COLOR_X);
	ft_check_characters(game);
	ft_printf(COLOR_G "Checked\n" COLOR_X);
	ft_printf(COLOR_W "Checking objects count\n" COLOR_X);
	ft_check_count(game);
	ft_printf(COLOR_G "Checked\n" COLOR_X);
	ft_printf(COLOR_W "Checking map reachibilty\n" COLOR_X);
	ft_check_reach(game);
	ft_printf(COLOR_G "Checked\n" COLOR_X);
}
